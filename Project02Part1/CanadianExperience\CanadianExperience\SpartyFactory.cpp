...
std::shared_ptr<CActor> CSpartyFactory::Create()
{
    ...
    auto mallet = make_shared<CImageDrawable>(L"Foam Finger", L"images/mallet.png");
    mallet->SetCenter(Point(0, 100));
    mallet->SetPosition(Point(-75, 120));
    rarm->AddChild(mallet);
