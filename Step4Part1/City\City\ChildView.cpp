...
BEGIN_MESSAGE_MAP(CChildView, CWnd)
    ...
    ON_UPDATE_COMMAND_UI(ID_GARDEN_PRUNE32807, &CChildView::OnUpdateGardenPrune32807)
    ON_COMMAND(ID_GARDEN_PRUNE32807, &CChildView::OnGardenPrune32807)
...
{
    CPruneGarden::CTileVisitor visitor;
    mCity.Accept(&visitor);
    Invalidate;
}

//add garden to landscape
void CChildView::OnLandscapingGarden()
{
    AddLandscape(L"garden.png");
}

//update mouse history and check
...
//view mouse history
//since mShowHistory is false the reverse will be true and show
...
//update garden
void CChildView::OnUpdateGardenPrune32807(CCmdUI* pCmdUI)
{
}

//prune a single garden
void CChildView::OnGardenPrune32807()
{
