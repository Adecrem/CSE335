...
/** \brief CCanadianExperienceApp initialization
...
BOOL CCanadianExperienceApp::InitInstance()
{
    ...
    pFrame->MoveWindow(100, 80, 1100, 800);
    pFrame->ShowWindow(SW_SHOW);
	pFrame->UpdateWindow();
	return TRUE;
}

/** \brief Exit this program 
 * \returns exit code */
...
/** \brief Exchange data between the class and the dialog box 
...
/** \brief App command to run the dialog */
